...
export const Skills: React.FC = () => {
  ...
  const renderToolsForCategory = () => {
    switch (toolCategory) {
      ...
      case "testing":
        return [
          "Jest / Testing Library (introductory testing for React components)",
        ];
      case "debugging":
        return [
          "Browser DevTools for debugging, layout inspection, and performance checks",
        ];
      default:
        return [];
    }
    ...
    >
      ...
      <Card title="Overview" content="">
        <Text size="medium">
          ...
          wiring up business logic, and modeling data. I focus on writing
          maintainable code and learning modern tools that support clean
          workflows. Occasionally, I continue to explore new technologies and
          frameworks to expand my skill set.
        </Text>
      </Card>
      ...
      >
        ...
        <Card title="Tools" content="">
          ...
          >
            <Text size="medium">
              Select a category to see the tools I use:
            </Text>
