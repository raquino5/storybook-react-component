...
export const BasicInfo: React.FC = () => {
  ...
  const handleViewResumeClick = () => {
    window.open('/resume/resume-portfolio.pdf', '_blank', 'noopener,noreferrer');
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            I like turning requirements into clean, reusable UI components and building
            production-ready workflows. This portfolio highlights coursework and projects where I
            experiment with what my industry can offer.
          </p>
          ...
          >
            Outside of coding and development, I enjoy playing video games, exploring new tech
            trends, and contributing to open-source projects. Feel free to reach out if you’d like
        ...
        {/* Quick Facts */}
        <Card title="Quick Facts" content="A quick snapshot of where I am in my journey.">
          <Table
          ...
          >
            Actively exploring opportunities for internships, part-time work, and collaboration on
            front-end projects.
          </div>
        </Card>
      </div>
