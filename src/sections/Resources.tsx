  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text size="medium">
          What can be seen here are the list of tools, references, and platforms that continuously
          supports my learning throughout in and outside of full stack development and my courses.
        </Text>
      </header>
